        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="projectName">
                        <Input type="text" v-model="searchForm.projectName" placeholder="项目名称" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="studentName">
                        <Input type="text" v-model="searchForm.studentName" placeholder="学生姓名" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="workName">
                        <Input type="text" v-model="searchForm.workName" placeholder="操作人" clearable style="width: 150px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getScoreDataList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
